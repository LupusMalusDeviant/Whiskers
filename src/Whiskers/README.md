...
```bash
dotnet build Whiskers.csproj          # 0 warnings expected
dotnet test ../Whiskers.Tests/        # xUnit suite
dotnet run --project Whiskers.csproj  # listens on :8080
```
