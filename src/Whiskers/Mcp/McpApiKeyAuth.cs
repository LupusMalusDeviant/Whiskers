...
public class McpApiKeyStore : IMcpApiKeyStore
{
    ...
    public McpApiKeyStore(ILogger<McpApiKeyStore> logger, string? filePath = null, DataPathOptions? dataPaths = null)
    {
        _filePath = filePath ?? (dataPaths ?? DataPathOptions.Default).ApiKeysJson;
        _logger = logger;
    }
