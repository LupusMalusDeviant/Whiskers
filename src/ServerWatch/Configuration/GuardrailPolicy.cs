...
/// read-only autonomous, writes need confirmation, ServerWatch itself is protected.</summary>
public class GuardrailPolicy
{
    ...
    /// <summary>Restrictive default: read-only autonomous, writes via confirmation, ServerWatch protected,
